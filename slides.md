...
##  Libro Pro Git
[Web](https://git-scm.com/book/es/v2) | [PDF](https://github.com/progit/progit2-es/releases/download/2.1.23/progit.pdf) | [EPUB](https://github.com/progit/progit2-es/releases/download/2.1.23/progit.epub)

---

# Recursos adicionales

[Migración de TFVC a Git](https://learn.microsoft.com/es-es/devops/develop/git/migrate-from-tfvc-to-git)
[Migración a Git desde el control de versiones centralizado](https://learn.microsoft.com/es-es/devops/develop/git/centralized-to-git)
[Funcionalidades de Git y TFVC](https://learn.microsoft.com/es-es/azure/devops/repos/tfvc/comparison-git-tfvc?view=azure-devops#git-and-tfvc-capabilities)
